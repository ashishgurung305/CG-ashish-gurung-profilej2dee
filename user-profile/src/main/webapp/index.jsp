...
<body id="page-top">
	...
	<nav
		...
		<div class="container">
			<figure>
				<img class="logo-img" src="images/logo.png" alt="sing up image">
			</figure>
			<button
	...
	<header class="masthead hero text-white text-center">
		<div class="container overlay d-flex align-items-center flex-column">
		</div>
		<div class="content container">
		<img src="images/starbuck.png" width="20%" />
			<h1 class="title">EARN MILES
WITH STARBUCKS</h1>
			<p class="description">
				Earn 1 mile per $1* spent at Starbucks when you join Delta SkyMiles & Starbucks Rewards and link your accounts.
			</p>
			<a href="#" class="cta-button">JOIN NOW</a>
			<p class="tax	">*Excludes taxes and gratuities. At participating stores. Some restrictions apply. For full details, visit deltastarbucks.com/terms</p>
		</div>
	</header>
